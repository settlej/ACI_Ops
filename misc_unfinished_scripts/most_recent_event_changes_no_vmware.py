...
def gatheranddisplayrecentevents():
    while True:
        ...
        print("\nEvents loading...\n")
        url = """https://localhost/api/node/class/eventRecord.json?query-target-filter=and(not(wcard(eventRecord.dn,%22__ui_%22)),ne(eventRecord.code,"E4204947"))&order-by=eventRecord.created|desc&page=0&page-size=100"""
