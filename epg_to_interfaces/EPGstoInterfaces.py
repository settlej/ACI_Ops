...
def main():
    ...
    if selection == '1':
        ...
        while True:
            try:
                selectedinterfaces = raw_input("Select interface(s) by number: ")
        ...
        while True:
            try:
                askepgnum = raw_input("which number?: ")
        ...
        for epg in sorted(epgsinglelist):
            ...
            while True:
                try:
                    vlan = raw_input('pick a vlan number: ')
