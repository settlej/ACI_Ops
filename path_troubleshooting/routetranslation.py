...
def sourceEPGinfo():
    print('\n')
    tenant = raw_input("(EPG1) What tenant [default=SI] ") or 'SI'
    app = raw_input("(EPG1) What App [default=APP-HQ] ") or 'APP-HQ'
    epg = raw_input("(EPG1) What epg [default=EPG-VL9-SERVERS] ") or 'EPG-VL9-SERVERS'
...
def destEPGinfo():
    ...
    tenant = raw_input("(EPG2) What tenant [default=SI] ") or 'SI'
    app = raw_input("(EPG2) What App [default=APP-ISE] ") or 'APP-ISE'
    epg = raw_input("(EPG2) What epg [default=EPG-VL10-ISE] ") or 'EPG-VL10-ISE'
...
def iproutecheckfromleaf():
    cidrcollection = {}
    askleaf = raw_input("What leaf [default=101] ") or 101
